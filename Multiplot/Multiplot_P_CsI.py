...
path='../Data/CsI/CNF/data/'
name='Cal_'
ext='.xy'
#----------------------------Archivos--Fondo------------------------------------------
Fondo = genfromtxt(path+'Fondo4.xy') #con antes y despues se promedia u y o
#Antes:
Cd109F_a = genfromtxt(path+name+'Cd11'+ext)
Na22F_a = genfromtxt(path+name+'Na11'+ext)
Co60F_a = genfromtxt(path+name+'Co11'+ext)
Cs137F_a = genfromtxt(path+name+'Cs11'+ext)
#Despues:
Cd109F_d = genfromtxt(path+name+'Cd12'+ext)
Na22F_d =  genfromtxt(path+name+'Na12'+ext)
Co60F_d =  genfromtxt(path+name+'Co12'+ext)
Cs137F_d =  genfromtxt(path+name+'Cs12'+ext)

#----------------------------Archivos--PatronU------------------------------------------
PatronU = genfromtxt(path+'P_Uranio.xy') #con antes y despues se promedia u y o
#Antes:
...
#----------------------------Archivos--PatronTh------------------------------------------
PatronTh = genfromtxt(path +'P_Torio.xy') #con antes y despues se promedia u y o
#Antes:
...
#----------------------------Archivos--PatronK------------------------------------------
PatronK = genfromtxt(path+'P_Potasio.xy') #con antes y despues se promedia u y o
#Antes:
Cd109K_a = genfromtxt(path+name+'Cd5'+ext)
Na22K_a = genfromtxt(path+name+'Na5'+ext)
Co60K_a = genfromtxt(path+name+'Co5'+ext)
Cs137K_a = genfromtxt(path+name+'Cs5'+ext)
#Despues:
Cd109K_d = genfromtxt(path+name+'Cd6'+ext)
Na22K_d = genfromtxt(path+name+'Na6'+ext)
Co60K_d = genfromtxt(path+name+'Co6'+ext)
Cs137K_d = genfromtxt(path+name+'Cs6'+ext)

#----------------------------Archivos--Muestra------------------------------------------
Guayana=genfromtxt(path+'G29517.xy') #con antes y despues se promedia u y o
#Antes:
Cd109G_a = genfromtxt(path+name+'Cd9'+ext)
Na22G_a = genfromtxt(path+name+'Na9'+ext)
Co60G_a = genfromtxt(path+name+'Co9'+ext)
Cs137G_a = genfromtxt(path+name+'Cs9'+ext)
#Despues:
Cd109G_d = genfromtxt(path+name+'Cd10'+ext)
Na22G_d = genfromtxt(path+name+'Na10'+ext)
Co60G_d = genfromtxt(path+name+'Co10'+ext)
Cs137G_d = genfromtxt(path+name+'Cs10'+ext)
...
SumaFNa_a = IntegralSencillo(1189,Na22F_a)
SumaFCo_a = IntegralSencillo(1654,Co60F_a)
# despues Fondo------------
...
SumaFNa_d = IntegralSencillo(1179,Na22F_d)
SumaFCo_d = IntegralSencillo(1647,Co60F_d)
...
CanalCsU_a = IntegralSencillo(440,Cs137U_a)   
CanalNa1U_a = IntegralSencillo(342,Na22U_a)  
CanalNa2U_a = IntegralSencillo(386,Na22U_a)
Canal1CoU_a = IntegralDoble2(769,873,Co60U_a)[0]
Canal2CoU_a = IntegralDoble2(769,873,Co60U_a)[1]
SumaUNa_a = IntegralSencillo(1182,Na22F_a)
SumaUCo_a = IntegralSencillo(1647,Co60F_a)
# despues U-------------
CanalCdU_d = IntegralSencilloCd(70,Cd109U_d) #(canal,archivo)
CanalCsU_d = IntegralSencillo(442,Cs137U_d)  
CanalNa1U_d = IntegralSencillo(345,Na22U_d) 
CanalNa2U_d = IntegralSencillo(842,Na22U_d) 
Canal1CoU_d = IntegralDoble2(778,880,Co60U_d)[0]
Canal2CoU_d = IntegralDoble2(778,880,Co60U_d)[1]
SumaUNa_d = IntegralSencillo(1185,Na22F_d)
SumaUCo_d = IntegralSencillo(1669,Co60F_d)
...
#---------------------------------THORIO-----------------------------------------------
# antes Th--------------
CanalCdTh_a = IntegralSencilloCd(71,Cd109Th_a) #(canal,archivo)
CanalCsTh_a = IntegralSencillo(442,Cs137Th_a)  
CanalNa1Th_a = IntegralSencillo(343,Na22Th_a) 
CanalNa2Th_a = IntegralSencillo(835,Na22Th_a) 
Canal1CoTh_a = IntegralDoble2(771,873,Co60Th_a)[0]
Canal2CoTh_a = IntegralDoble2(771,873,Co60Th_a)[1]
SumaThNa_a = IntegralSencillo(1182,Na22F_a)
SumaThCo_a = IntegralSencillo(1656,Co60F_a)
# despues Th------------
CanalCdTh_d = IntegralSencilloCd(70,Cd109Th_d) #(canal,archivo)
CanalCsTh_d = IntegralSencillo(440,Cs137Th_d)   
CanalNa1Th_d = IntegralSencillo(342,Na22Th_d)  
CanalNa2Th_d = IntegralSencillo(386,Na22Th_d)
Canal1CoTh_d = IntegralDoble2(769,873,Co60Th_d)[0]
Canal2CoTh_d = IntegralDoble2(769,873,Co60Th_d)[1]
SumaThNa_d = IntegralSencillo(1182,Na22F_d)
SumaThCo_d = IntegralSencillo(1647,Co60F_d)
...
#---------------------------------POTASIO-----------------------------------------------
# antes K------------
CanalCdK_a = IntegralSencilloCd(71,Cd109K_a) #(canal,archivo)
CanalCsK_a = IntegralSencillo(445,Cs137K_a)   
CanalNa1K_a = IntegralSencillo(348,Na22K_a)  
CanalNa2K_a = IntegralSencillo(343,Na22K_a)
Canal1CoK_a = IntegralDoble2(777,883,Co60K_a)[0]
Canal2CoK_a = IntegralDoble2(777,883,Co60K_a)[1]
SumaKNa_a = IntegralSencillo(1189,Na22F_a)
SumaKCo_a = IntegralSencillo(1668,Co60F_a)
# despues K------------
CanalCdK_d = IntegralSencilloCd(71,Cd109K_d) #(canal,archivo)
CanalCsK_d = IntegralSencillo(442,Cs137K_d)   
CanalNa1K_d = IntegralSencillo(343,Na22K_d)  
CanalNa2K_d = IntegralSencillo(835,Na22K_d)
Canal1CoK_d = IntegralDoble2(771,873,Co60K_d)[0]
Canal2CoK_d = IntegralDoble2(771,873,Co60K_d)[1]
SumaKNa_d = IntegralSencillo(1184,Na22F_d)
SumaKCo_d = IntegralSencillo(1652,Co60F_d)
...
#--------------------------------GUAYANA-----------------------------------------------
# antes Guayana-------------
CanalCdG_a = IntegralSencilloCd(72,Cd109G_a)  #(canal,archivo)
CanalCsG_a = IntegralSencillo(442,Cs137G_a)  
CanalNa1G_a = IntegralSencillo(346,Na22G_a)  
CanalNa2G_a = IntegralSencillo(843,Na22G_a) 
Canal1CoG_a = IntegralDoble2(781,887,Co60G_a)[0]
Canal2CoG_a = IntegralDoble2(781,887,Co60G_a)[1]
GK_a = IntegralSencillo(953,Guayana)
GK_d = IntegralSencillo(953,Guayana)
SumaGNa_a = IntegralSencillo(1190,Na22F_a)
SumaGCo_a = IntegralSencillo(1690,Co60F_a)
# despues Guayana------------
CanalCdG_d = IntegralSencilloCd(70,Cd109G_d) #(canal,archivo)
CanalCsG_d = IntegralSencillo(442,Cs137G_d)  
CanalNa1G_d = IntegralSencillo(342,Na22G_d)  
CanalNa2G_d = IntegralSencillo(830,Na22G_d) 
Canal1CoG_d = IntegralDoble2(766,872,Co60G_d)[0]
Canal2CoG_d = IntegralDoble2(766,872,Co60G_d)[1]
SumaGNa_d = IntegralSencillo(1173,Na22F_d)
SumaGCo_d = IntegralSencillo(1640,Co60F_d)
#1460.82
