...
def Piniciales(a,c): #a es el archivo y c es el canal donde se encuentra el pico 
    x=a[:,0]
    return [a[int(c-30):int(c+30),1].max(),x[a[int(c-10):int(c+10),1].argmax() + c-10], 2.0, a[c-30,1], (a[c-30,1]-a[c+30-((c-3+1)/0.11),1])/(a[c-30,0]-a[c+30-((c-3+1)/0.11),0]),x[a[int(c-30):int(c+30),1].argmax() + c-30]] #Retorna una lista [] con los parametros iniciales
#--------------------------------------------------------------------------
def Piniciales2(a,c): #a es el archivo y c es el canal donde se encuentra el pico 
    x=a[:,0]
    return [a[int(c-30):int(c+30),1].max(),a[int(c-30):int(c+30),1].argmax()+c-30,30, a[int(c-30),1], (a[int(c-30),1]-a[int(c+30-(c-30+1)),1])/(a[int(c-30),0]-a[int(c+30-((c-30+1))),0]),x[a[int(c-30):int(c+30),1].argmax() + c-30]]
#--------------------------------------------------------------------------
def Piniciales22(a,c): #a es el archivo y c es el canal donde se encuentra el pico 
    x=a[:,0]
    return [a[int(c-10):int(c+10),1].max(),c,10, a[c-10,1], (a[int(c-10),1]-a[int(c+10-(c-10+1)),1])/(a[int(c-10),0]-a[int(c+10-((c-10+1))),0]),x[a[int(c-10):int(c+10),1].argmax() + c-10]]
#--------------------------------------------------------------------------
def Piniciales222(a,c): #a es el archivo y c es el canal donde se encuentra el pico 
    x=a[:,0]
    return [a[int(c-30):int(c+30),1].max(),c,30.0, 100.0,20.0,1600.0,1.0]
...
path='../Data/BGO/CNF/data/'
name='Cal_'
ext='.xy'
#----------------------------Archivos--Fondo------------------------------------------
Fondo = genfromtxt(path+'Fondo9h.xy') #con antes y despues se promedia u y o
#Antes:
Cd109F_a = genfromtxt(path+name+'Cd9'+ext)
Na22F_a = genfromtxt(path+name+'Na9'+ext)
Co60F_a = genfromtxt(path+name+'Co9'+ext)
Cs137F_a = genfromtxt(path+name+'Cs9'+ext)
#Despues:
Cd109F_d = genfromtxt(path+name+'Cd10'+ext)
Na22F_d =  genfromtxt(path+name+'Na10'+ext)
Co60F_d =  genfromtxt(path+name+'Co10'+ext)
Cs137F_d =  genfromtxt(path+name+'Cs10'+ext)

#----------------------------Archivos--PatronU------------------------------------------
PatronU = genfromtxt(path+'PatronU.xy') #con antes y despues se promedia u y o
#Antes:
Cd109U_a = genfromtxt(path+name+'Cd7'+ext)
Na22U_a = genfromtxt(path+name+'Na7'+ext)
Co60U_a = genfromtxt(path+name+'Co7'+ext)
Cs137U_a = genfromtxt(path+name+'Cs7'+ext)
#Despues:
Cd109U_d = genfromtxt(path+name+'Cd8'+ext)
Na22U_d =  genfromtxt(path+name+'Na8'+ext)
Co60U_d =  genfromtxt(path+name+'Co8'+ext)
Cs137U_d =  genfromtxt(path+name+'Cs8'+ext)

#----------------------------Archivos--PatronTh------------------------------------------
PatronTh = genfromtxt(path +'PatronTh.xy') #con antes y despues se promedia u y o
#Antes:
Cd109Th_a = genfromtxt(path+name+'Cd6'+ext)
Na22Th_a = genfromtxt(path+name+'Na6'+ext)
Co60Th_a = genfromtxt(path+name+'Co6'+ext)
Cs137Th_a = genfromtxt(path+name+'Cs6'+ext)
#Despues:
Cd109Th_d = genfromtxt(path+name+'Cd7'+ext)
Na22Th_d = genfromtxt(path+name+'Na7'+ext)
Co60Th_d = genfromtxt(path+name+'Co7'+ext)
Cs137Th_d = genfromtxt(path+name+'Cs7'+ext)

#----------------------------Archivos--PatronK------------------------------------------
PatronK = genfromtxt(path+'PatronK.xy') #con antes y despues se promedia u y o
#Antes:
Cd109K_a = genfromtxt(path+name+'Cd4'+ext)
Na22K_a = genfromtxt(path+name+'Na4'+ext)
Co60K_a = genfromtxt(path+name+'Co4'+ext)
Cs137K_a = genfromtxt(path+name+'Cs4'+ext)
#Despues:
Cd109K_d = genfromtxt(path+name+'Cd5'+ext)
Na22K_d = genfromtxt(path+name+'Na5'+ext)
Co60K_d = genfromtxt(path+name+'Co5'+ext)
Cs137K_d = genfromtxt(path+name+'Cs5'+ext)

#----------------------------Archivos--Muestra------------------------------------------
Guayana=genfromtxt(path+'Guayana15h.xy') #con antes y despues se promedia u y o
#Antes:
Cd109G_a = genfromtxt(path+name+'Cd8'+ext)
Na22G_a = genfromtxt(path+name+'Na8'+ext)
Co60G_a = genfromtxt(path+name+'Co8'+ext)
Cs137G_a = genfromtxt(path+name+'Cs8'+ext)
#Despues:
Cd109G_d = genfromtxt(path+name+'Cd9'+ext)
Na22G_d = genfromtxt(path+name+'Na9'+ext)
Co60G_d = genfromtxt(path+name+'Co9'+ext)
Cs137G_d = genfromtxt(path+name+'Cs9'+ext)

#==============================Picos, Archivos=========================================

#-------------------------------FONDO-----------------------------------------------
# antes Fondo------------
CanalCdF_a = IntegralSencilloCd(32,Cd109F_a) #(canal,archivo)
CanalCsF_a = IntegralSencillo(205,Cs137F_a)  
CanalNa1F_a = IntegralSencillo(106,Na22F_a)  
CanalNa2F_a = IntegralSencillo(391,Na22F_a) 
Canal1CoF_a = IntegralDoble2(360,408,Co60F_a)[0]
Canal2CoF_a = IntegralDoble2(360,408,Co60F_a)[1]
SumaFNa_a = IntegralSencillo(544,Na22F_a)
SumaFCo_a = IntegralSencillo(762,Co60F_a)
# despues Fondo------------
CanalCdF_d = IntegralSencilloCd(32,Cd109F_d)  #(canaL,archivo)
CanalCsF_d = IntegralSencillo(205,Cs137F_d)  
CanalNa1F_d = IntegralSencillo(106,Na22F_d)  
CanalNa2F_d = IntegralSencillo(391,Na22F_d)
Canal1CoF_d = IntegralDoble2(360,408,Co60F_d)[0]
Canal2CoF_d = IntegralDoble2(360,408,Co60F_d)[1]
SumaFNa_d = IntegralSencillo(544,Na22F_d)
SumaFCo_d = IntegralSencillo(762,Co60F_d)
...
#---------------------------------URANIO-----------------------------------------------
# antes U---------------
CanalCdU_a = IntegralSencilloCd(32,Cd109U_a) #(canal,archivo)
CanalCsU_a = IntegralSencillo(205,Cs137U_a)   
CanalNa1U_a = IntegralSencillo(106,Na22U_a)  
CanalNa2U_a = IntegralSencillo(391,Na22U_a)
Canal1CoU_a = IntegralDoble2(360,408,Co60U_a)[0]
Canal2CoU_a = IntegralDoble2(360,408,Co60U_a)[1]
SumaUNa_a = IntegralSencillo(544,Na22F_a)
SumaUCo_a = IntegralSencillo(762,Co60F_a)
# despues U-------------
CanalCdU_d = IntegralSencilloCd(32,Cd109U_d) #(canal,archivo)
CanalCsU_d = IntegralSencillo(205,Cs137U_d)  
CanalNa1U_d = IntegralSencillo(106,Na22U_d) 
CanalNa2U_d = IntegralSencillo(391,Na22U_d) 
Canal1CoU_d = IntegralDoble2(360,408,Co60U_d)[0]
Canal2CoU_d = IntegralDoble2(360,408,Co60U_d)[1]
SumaUNa_d = IntegralSencillo(544,Na22F_d)
SumaUCo_d = IntegralSencillo(762,Co60F_d)
...
#---------------------------------THORIO-----------------------------------------------
# antes Th--------------
CanalCdTh_a = IntegralSencilloCd(32,Cd109Th_a) #(canal,archivo)
CanalCsTh_a = IntegralSencillo(205,Cs137Th_a)  
CanalNa1Th_a = IntegralSencillo(106,Na22Th_a) 
CanalNa2Th_a = IntegralSencillo(391,Na22Th_a) 
Canal1CoTh_a = IntegralDoble2(360,408,Co60Th_a)[0]
Canal2CoTh_a = IntegralDoble2(360,408,Co60Th_a)[1]
SumaThNa_a = IntegralSencillo(544,Na22F_a)
SumaThCo_a = IntegralSencillo(762,Co60F_a)
# despues Th------------
CanalCdTh_d = IntegralSencilloCd(32,Cd109Th_d) #(canal,archivo)
CanalCsTh_d = IntegralSencillo(205,Cs137Th_d)   
CanalNa1Th_d = IntegralSencillo(106,Na22Th_d)  
CanalNa2Th_d = IntegralSencillo(391,Na22Th_d)
Canal1CoTh_d = IntegralDoble2(360,408,Co60Th_d)[0]
Canal2CoTh_d = IntegralDoble2(360,408,Co60Th_d)[1]
SumaThNa_d = IntegralSencillo(544,Na22F_d)
SumaThCo_d = IntegralSencillo(762,Co60F_d)
...
#---------------------------------POTASIO-----------------------------------------------
# antes K------------
CanalCdK_a = IntegralSencilloCd(32,Cd109K_a) #(canal,archivo)
CanalCsK_a = IntegralSencillo(205,Cs137K_a)   
CanalNa1K_a = IntegralSencillo(106,Na22K_a)  
CanalNa2K_a = IntegralSencillo(391,Na22K_a)
Canal1CoK_a = IntegralDoble2(360,408,Co60K_a)[0]
Canal2CoK_a = IntegralDoble2(360,408,Co60K_a)[1]
SumaKNa_a = IntegralSencillo(544,Na22F_a)
SumaKCo_a = IntegralSencillo(762,Co60F_a)
# despues K------------
CanalCdK_d = IntegralSencilloCd(32,Cd109K_d) #(canal,archivo)
CanalCsK_d = IntegralSencillo(205,Cs137K_d)   
CanalNa1K_d = IntegralSencillo(106,Na22K_d)  
CanalNa2K_d = IntegralSencillo(391,Na22K_d)
Canal1CoK_d = IntegralDoble2(360,408,Co60K_d)[0]
Canal2CoK_d = IntegralDoble2(360,408,Co60K_d)[1]
SumaKNa_d = IntegralSencillo(544,Na22F_d)
SumaKCo_d = IntegralSencillo(762,Co60F_d)
...
#--------------------------------GUAYANA-----------------------------------------------
# antes Guayana-------------
CanalCdG_a = IntegralSencilloCd(32,Cd109G_a)  #(canal,archivo)
CanalCsG_a = IntegralSencillo(205,Cs137G_a)  
CanalNa1G_a = IntegralSencillo(106,Na22G_a)  
CanalNa2G_a = IntegralSencillo(391,Na22G_a) 
Canal1CoG_a = IntegralDoble2(360,408,Co60G_a)[0]
Canal2CoG_a = IntegralDoble2(360,408,Co60G_a)[1]
#GK_a = IntegralSencillo(953,Guayana)
#GK_d = IntegralSencillo(953,Guayana)
SumaGNa_a = IntegralSencillo(544,Na22F_a)
SumaGCo_a = IntegralSencillo(762,Co60F_a)
# despues Guayana------------
CanalCdG_d = IntegralSencilloCd(32,Cd109G_d) #(canal,archivo)
CanalCsG_d = IntegralSencillo(205,Cs137G_d)  
CanalNa1G_d = IntegralSencillo(106,Na22G_d)  
CanalNa2G_d = IntegralSencillo(391,Na22G_d) 
Canal1CoG_d = IntegralDoble2(360,408,Co60G_d)[0]
Canal2CoG_d = IntegralDoble2(360,408,Co60G_d)[1]
SumaGNa_d = IntegralSencillo(544,Na22F_d)
SumaGCo_d = IntegralSencillo(762,Co60F_d)
#1460.82
...
PatronThRebinX2 = delete(PatronKRebinX,len(PatronKRebinX)-1)
...
GuayanaNormaY = (GuayanaRebinY/(15.0*60))
FondoNormaY = FondoRebinY/(9.0*60)
...
# GuayanaNaI = genfromtxt(path+'Guayana15h.xy')    #realmente es BGO
...
# gcf().subplots_adjust(right=0.98)
# gcf().subplots_adjust(left=0.10)
# gcf().subplots_adjust(top=0.96)



# GuayanaGeFigura, = ax4.plot((0.386001695767*(GuayanaGe[:,0])-26.0031922218),GuayanaGe[:,1]/100,lw=2.0,ls='steps-mid',color='g')
# GuayanaNaIFigura, = ax4.plot(GuayanaRebinX2,GuayanaDef*1.5,lw=2.0,ls='steps-mid',color='b')

# GuayanaGeFigura, = ax3.plot((0.386001695767*(GuayanaGe[:,0])-26.0031922218),GuayanaGe[:,1]/100,lw=2.0,ls='steps-mid',color='g')
# GuayanaNaIFigura, = ax3.plot(GuayanaRebinX2,GuayanaDef*1.5,lw=2.0,ls='steps-mid',color='b')

# GuayanaNaIFigura2, = ax2.plot(GuayanaRebinX2,GuayanaDef*10,lw=2.0,ls='steps-mid',color='b')
...
# GuayanaNaIFigura2, = ax1.plot(GuayanaRebinX2,GuayanaDef*5,lw=2.0,ls='steps-mid',color='b')
...
# ax1.legend([GuayanaNaIFigura2,PatronUGeFigura1,PatronThGeFigura1,PatronKGeFigura1], ["Sample-BGO$\\times{7}$","$^{238}$U (Ge)$/100$","$^{232}$Th (Ge)$/100$",], fontsize=17.5, bbox_to_anchor=(0.50, 0.85, 1., .102), loc=2, ncol=1, borderaxespad=-0.5)

# ax2.legend([GuayanaNaIFigura2,PatronUGeFigura1,PatronThGeFigura1,PatronKGeFigura1], ["Sample-BGO$\\times{10}$","$^{238}$U (Ge)$/100$","$^{232}$Th (Ge)$/100$"], fontsize=16.5, bbox_to_anchor=(0.50, 0.85, 1., .100), loc=2, ncol=1, borderaxespad=-0.5)

# ax3.legend([GuayanaGeFigura,GuayanaNaIFigura], ["Sample-Ge$/100$","Sample-BGO"], fontsize=17.5, bbox_to_anchor=(0.50, 0.85, 1., .102), loc=2, ncol=1, borderaxespad=-0.3)

# ax4.legend([GuayanaGeFigura,GuayanaNaIFigura], ["Sample-Ge$/100$","Sample-BGO"], fontsize=17.5, bbox_to_anchor=(0.50, 0.85, 1., .102), loc=2, ncol=1, borderaxespad=-0.3)
...
# f.text(0.5, 0.05, 'Energy (keV)', fontsize=19, ha='center', va='center')
...
# f.show()
# #f.legend()
# f.savefig('figuras/Multiplot_P_BGO.eps')
# plt.show()
