...
def IntegralSencillo(C,archivo):
    ...
    # gcf().subplots_adjust(top=0.9 )      #esto es para la grafica!
...
path='../Data/NaI2x2_old/mca/data/'
name='Cal_'
ext='.xy'
#----------------------------Archivos--Fondo------------------------------------------
Fondo = genfromtxt(path+'Fondo_15h.xy') #con antes y despues se promedia u y o
#Antes:
...
#----------------------------Archivos--PatronU------------------------------------------
PatronU = genfromtxt(path+'Patron_U1.5h.xy') #con antes y despues se promedia u y o
#Antes:
Cd109U_a = genfromtxt(path+name+'Cd1'+ext)
Na22U_a = genfromtxt(path+name+'Na1'+ext)
Co60U_a = genfromtxt(path+name+'Co1'+ext)
Cs137U_a = genfromtxt(path+name+'Cs1'+ext)
#Despues:
Cd109U_d = genfromtxt(path+name+'Cd2'+ext)
Na22U_d =  genfromtxt(path+name+'Na2'+ext)
Co60U_d =  genfromtxt(path+name+'Co2'+ext)
Cs137U_d =  genfromtxt(path+name+'Cs2'+ext)

#----------------------------Archivos--PatronTh------------------------------------------
PatronTh = genfromtxt(path +'Patron_Th1.5h.xy') #con antes y despues se promedia u y o
#Antes:
Cd109Th_a = genfromtxt(path+name+'Cd1'+ext)
Na22Th_a = genfromtxt(path+name+'Na1'+ext)
Co60Th_a = genfromtxt(path+name+'Co1'+ext)
Cs137Th_a = genfromtxt(path+name+'Cs1'+ext)
#Despues:
Cd109Th_d = genfromtxt(path+name+'Cd2'+ext)
Na22Th_d = genfromtxt(path+name+'Na2'+ext)
Co60Th_d = genfromtxt(path+name+'Co2'+ext)
Cs137Th_d = genfromtxt(path+name+'Cs2'+ext)

#----------------------------Archivos--PatronK------------------------------------------
PatronK = genfromtxt(path+'Patron_K1h.xy') #con antes y despues se promedia u y o
#Antes:
Cd109K_a = genfromtxt(path+name+'Cd1'+ext)
Na22K_a = genfromtxt(path+name+'Na1'+ext)
Co60K_a = genfromtxt(path+name+'Co1'+ext)
Cs137K_a = genfromtxt(path+name+'Cs1'+ext)
#Despues:
Cd109K_d = genfromtxt(path+name+'Cd2'+ext)
Na22K_d = genfromtxt(path+name+'Na2'+ext)
Co60K_d = genfromtxt(path+name+'Co2'+ext)
Cs137K_d = genfromtxt(path+name+'Cs2'+ext)

#----------------------------Archivos--Muestra------------------------------------------
Guayana=genfromtxt(path+'Guayana_12h.xy') #con antes y despues se promedia u y o
#Antes:
Cd109G_a = genfromtxt(path+name+'Cd4'+ext)
Na22G_a = genfromtxt(path+name+'Na4'+ext)
Co60G_a = genfromtxt(path+name+'Co4'+ext)
Cs137G_a = genfromtxt(path+name+'Cs4'+ext)
#Despues:
Cd109G_d = genfromtxt(path+name+'Cd5'+ext)
Na22G_d = genfromtxt(path+name+'Na5'+ext)
Co60G_d = genfromtxt(path+name+'Co5'+ext)
Cs137G_d = genfromtxt(path+name+'Cs5'+ext)

#==============================Picos, Archivos=========================================

#-------------------------------FONDO-----------------------------------------------Na22F_
# antes Fondo------------
CanalCdF_a = IntegralSencilloCd(67,Cd109F_a) #(canal,archivo)
CanalCsF_a = IntegralSencillo(443,Cs137F_a)  
CanalNa1F_a = IntegralSencillo(346,Na22F_a)  
CanalNa2F_a = IntegralSencillo(838,Na22F_a) 
Canal1CoF_a = IntegralDoble2(771,876,Co60F_a)[0]
Canal2CoF_a = IntegralDoble2(771,876,Co60F_a)[1]
SumaFNa_a = IntegralSencillo(1186,Na22F_a)
SumaFCo_a = IntegralSencillo(1650,Co60F_a)
# despues Fondo------------
CanalCdF_d = IntegralSencilloCd(67,Cd109F_d)  #(canaL,archivo)
CanalCsF_d = IntegralSencillo(442,Cs137F_d)  
CanalNa1F_d = IntegralSencillo(347,Na22F_d)  
CanalNa2F_d = IntegralSencillo(839,Na22F_d)
Canal1CoF_d = IntegralDoble2(775,878,Co60F_d)[0]
Canal2CoF_d = IntegralDoble2(775,878,Co60F_d)[1]
SumaFNa_d = IntegralSencillo(1186,Na22F_d)
SumaFCo_d = IntegralSencillo(1661,Co60F_d)
...
#---------------------------------URANIO-----------------------------------------------
# antes U---------------
CanalCdU_a = IntegralSencilloCd(67,Cd109U_a) #(canal,archivo)
CanalCsU_a = IntegralSencillo(443,Cs137U_a)  
CanalNa1U_a = IntegralSencillo(346,Na22U_a)  
CanalNa2U_a = IntegralSencillo(838,Na22U_a) 
Canal1CoU_a = IntegralDoble2(771,876,Co60U_a)[0]
Canal2CoU_a = IntegralDoble2(771,876,Co60U_a)[1]
SumaUNa_a = IntegralSencillo(1186,Na22U_a)
SumaUCo_a = IntegralSencillo(1650,Co60U_a)
# despues Uondo------------
CanalCdU_d = IntegralSencilloCd(67,Cd109U_d)  #(canaL,archivo)
CanalCsU_d = IntegralSencillo(442,Cs137U_d)  
CanalNa1U_d = IntegralSencillo(347,Na22U_d)  
CanalNa2U_d = IntegralSencillo(839,Na22U_d)
Canal1CoU_d = IntegralDoble2(775,878,Co60U_d)[0]
Canal2CoU_d = IntegralDoble2(775,878,Co60U_d)[1]
SumaUNa_d = IntegralSencillo(1186,Na22U_d)
SumaUCo_d = IntegralSencillo(1661,Co60U_d)
...
CanalCdTh_a = IntegralSencilloCd(67,Cd109Th_a) #(canal,archivo)
CanalCsTh_a = IntegralSencillo(443,Cs137Th_a)  
CanalNa1Th_a = IntegralSencillo(346,Na22Th_a)  
CanalNa2Th_a = IntegralSencillo(838,Na22Th_a) 
Canal1CoTh_a = IntegralDoble2(771,876,Co60Th_a)[0]
Canal2CoTh_a = IntegralDoble2(771,876,Co60Th_a)[1]
SumaThNa_a = IntegralSencillo(1186,Na22Th_a)
SumaThCo_a = IntegralSencillo(1650,Co60Th_a)
# despues Thondo------------
CanalCdTh_d = IntegralSencilloCd(67,Cd109Th_d)  #(canaL,archivo)
CanalCsTh_d = IntegralSencillo(442,Cs137Th_d)  
CanalNa1Th_d = IntegralSencillo(347,Na22Th_d)  
CanalNa2Th_d = IntegralSencillo(839,Na22Th_d)
Canal1CoTh_d = IntegralDoble2(775,878,Co60Th_d)[0]
Canal2CoTh_d = IntegralDoble2(775,878,Co60Th_d)[1]
SumaThNa_d = IntegralSencillo(1186,Na22Th_d)
SumaThCo_d = IntegralSencillo(1661,Co60Th_d)
...
#---------------------------------POTASIO-----------------------------------------------
# antes K------------
CanalCdK_a = IntegralSencilloCd(67,Cd109K_a) #(canal,archivo)
CanalCsK_a = IntegralSencillo(443,Cs137K_a)  
CanalNa1K_a = IntegralSencillo(346,Na22K_a)  
CanalNa2K_a = IntegralSencillo(838,Na22K_a) 
Canal1CoK_a = IntegralDoble2(771,876,Co60K_a)[0]
Canal2CoK_a = IntegralDoble2(771,876,Co60K_a)[1]
SumaKNa_a = IntegralSencillo(1186,Na22K_a)
SumaKCo_a = IntegralSencillo(1650,Co60K_a)
# despues Kondo------------
CanalCdK_d = IntegralSencilloCd(67,Cd109K_d)  #(canaL,archivo)
CanalCsK_d = IntegralSencillo(442,Cs137K_d)  
CanalNa1K_d = IntegralSencillo(347,Na22K_d)  
CanalNa2K_d = IntegralSencillo(839,Na22K_d)
Canal1CoK_d = IntegralDoble2(775,878,Co60K_d)[0]
Canal2CoK_d = IntegralDoble2(775,878,Co60K_d)[1]
SumaKNa_d = IntegralSencillo(1186,Na22K_d)
SumaKCo_d = IntegralSencillo(1661,Co60K_d)
...
#--------------------------------GUAYANA-----------------------------------------------
# antes Guayana-------------
CanalCdG_a = IntegralSencilloCd(67,Cd109G_a)  #(canal,archivo)
CanalCsG_a = IntegralSencillo(445,Cs137G_a)  
CanalNa1G_a = IntegralSencillo(347,Na22G_a)  
CanalNa2G_a = IntegralSencillo(838,Na22G_a) 
Canal1CoG_a = IntegralDoble2(774,881,Co60G_a)[0]
Canal2CoG_a = IntegralDoble2(774,881,Co60G_a)[1]
#GK_a = IntegralSencillo(,Guayana)
#GK_d = IntegralSencillo(,Guayana)
SumaGNa_a = IntegralSencillo(1186,Na22F_a)
SumaGCo_a = IntegralSencillo(1660,Co60F_a)
# despues Guayana------------
CanalCdG_d = IntegralSencilloCd(70,Cd109G_d) #(canal,archivo)
CanalCsG_d = IntegralSencillo(442,Cs137G_d)  
CanalNa1G_d = IntegralSencillo(347,Na22G_d)  
CanalNa2G_d = IntegralSencillo(845,Na22G_d) 
Canal1CoG_d = IntegralDoble2(773,877,Co60G_d)[0]
Canal2CoG_d = IntegralDoble2(773,877,Co60G_d)[1]
SumaGNa_d = IntegralSencillo(1195,Na22F_d)
SumaGCo_d = IntegralSencillo(1657,Co60F_d)
#1460.82
...
GuayanaNormaY = (GuayanaRebinY/(12.0*60))
FondoNormaY = FondoRebinY/(15.0*60)
UNormaY = PatronURebinY/(1.5*60)
ThNormaY = PatronThRebinY/(1.5*60)
KNormaY = PatronKRebinY/(1*60)
...
#GuayanaNaI = genfromtxt(path+'Guayana_12h.xy')    #realmente es CsI
...
# GuayanaNaIFigura2, = ax2.plot(GuayanaRebinX2,GuayanaDef*100,lw=2.0,ls='steps-mid',color='b')
