...
Co60_regions=[cl.roi_cal(707,1173.2,817),
              #cl.roi_cal(720,[1173.22,1332.49],935,'Double_Gauss_Rect'),#cl.roi_cal(826,1332.49,935),
              cl.roi_cal(820,1332.49,950),
              #cl.roi_cal(1589,2505.71,1750)]
              cl.roi_cal(1560,2505.71,1730)]

Na22_regions=[cl.roi_cal(295,511,380),
              cl.roi_cal(760,1274.53,900),
              cl.roi_cal(1107,1785.53,1250)]

Cs137_regions=[cl.roi_cal(385,661.65,490)]

Cd109_regions=[cl.roi_cal(53,88.033,75)]
...
rois_set=[Co60_rois,Cs137_rois,Na22_rois,Cd109_rois]
#rois_set=[Co60_rois,Cs137_rois,Na22_rois]
#rois_set=[Co60_rois]
cal=cl.calibration(rois_set)

#path='../Data/NaI2X2/mca/'
path='../../Data/NaI2x2_old/mca/'
...
measure=[ 'Patron_K1h.mca','Patron_Th1.5h.mca',
          'Patron_U1.5h.mca','Chucuri_12h.mca',
          'Fondo_15h.mca']
# measure=['PatronU.mca','PatronTh.mca',
#          'PatronK.mca','Guayana8h.mca',
#          'Fondo11h.mca']
#CalMeasureIndex=[0,1,2,3,5]
CalMeasureIndex=[0,1,2,3,4]
...
Mspectra=[]
SubSpectraList=[] #lista de la resta de espectros

Eb=10.0
fondoSP=sp.spectra(path+'Fondo_15h.mca')
#fondoSP=sp.spectra(path+'Fondo11h.mca')
# fondoSP.set_cal(calprom[5][0],
#                 calprom[5][1])
fondoSP.set_cal(calprom[4][0],
                calprom[4][1])
fondoSP.rebining(Eb)
...
# plt.show()
#-------------------------------------
PU_regions=[Eroi.roi(1611,1764.49,1880)]
PTh_regions=[Eroi.roi(2432,2614.51,2720)]
PK_regions=[Eroi.roi(1305,1460.82,1550)]
Guayna_regions=[Eroi.roi(1611,1764.49,1880),
                Eroi.roi(2432,2614.51,2720),
                Eroi.roi(1305,1460.82,1550)]

fondo_regions=[Eroi.roi(1611,1764.49,1880),
                Eroi.roi(2432,2614.51,2720),
                Eroi.roi(1305,1460.82,1550)]
...
################################RESULTADOS##############################
K_NaI2x2,Th_NaI2x2,U_NaI2x2=[],[],[]
K_NaI2x2.append([dGuayanaPK_c[0],ddGuayanaPK_c,ActividadMK,dActividadMK])
Th_NaI2x2.append([dGuayanaTh_c[0],ddGuayanaTh_c,ActividadMTh,dActividadMTh])
U_NaI2x2.append([dGuayanaU_c[0],ddGuayanaU_c,ActividadMU,dActividadMU])
