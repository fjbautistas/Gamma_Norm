...
Co60_regions=[cl.roi_cal(790,1173.28,890)]#,
              #cl.roi_cal(905,1332.49,1015),
              #cl.roi_cal(1745,2505.71,1880)]

Na22_regions=[cl.roi_cal(340,511,410)]#,
              #cl.roi_cal(873,1274.53,960),
              #cl.roi_cal(1245,1785.53,1350)]

Cs137_regions=[cl.roi_cal(440,661.65,520)]

Cd109_regions=[cl.roi_cal(60,88.033,77)]
...
measure=['Patron_K.mca','Patron_Th.mca','Patron_U.mca','Chucuri12h.mca','Fondo14h.mca']
CalMeasureIndex=[2,2,2,3,1]
...
Eb=10.0
fondoSP=sp.spectra(path+'Fondo14h.mca')
...
#plt.show()
#-------------------------------------
PU_regions=[Eroi.roi(1633,1764.49,1840)]
PTh_regions=[Eroi.roi(2472,2614.51,2705)]
PK_regions=[Eroi.roi(1350,1460.82,1550)]
Guayna_regions=[Eroi.roi(1633,1764.49,1840),
                Eroi.roi(2472,2614.51,2705),
                Eroi.roi(1350,1460.82,1550)]
fondo_regions=[Eroi.roi(1633,1764.49,1840),
                Eroi.roi(2472,2614.51,2705),
                Eroi.roi(1350,1460.82,1550)]
...
################################RESULTADOS##############################
K_NaI3x3,Th_NaI3x3,U_NaI3x3=[],[],[]

K_NaI3x3.append([dGuayanaPK_c[0],ddGuayanaPK_c,ActividadMK,dActividadMK])
Th_NaI3x3.append([dGuayanaTh_c[0],ddGuayanaTh_c,ActividadMTh,dActividadMTh])
U_NaI3x3.append([dGuayanaU_c[0],ddGuayanaU_c,ActividadMU,dActividadMU])
