...
Co60_regions=[cl.roi_cal(720,1173.2,823),
              cl.roi_cal(826,1332.49,935),
              cl.roi_cal(1589,2505.71,1760)]

Na22_regions=[cl.roi_cal(308,511,380),
              cl.roi_cal(780,1274.53,890),
              cl.roi_cal(1139,1785.53,1240)]

Cs137_regions=[cl.roi_cal(400,661.65,500)]

Cd109_regions=[cl.roi_cal(54,88.033,90)]
...
measure=['P_Potasio.CNF','P_Torio.CNF','P_Uranio.CNF','G6H.CNF','Fondo4.CNF']
CalMeasureIndex=[0,1,2,3,6]
measureFactors=[1,1,1,1,2]
calprom=[]
...
Measure_SinF=[]
Eb=10.0
fondoSP=sp.spectra(path+'Fondo4.CNF')
...
#plt.show()
#-------------------------------------
PU_regions=[Eroi.roi(1611,1764.49,1900)]
PTh_regions=[Eroi.roi(2480,2614.51,2735)]
PK_regions=[Eroi.roi(1350,1460.82,1550)]
Guayna_regions=[Eroi.roi(1611,1764.49,1900),
                Eroi.roi(2480,2614.51,2735),
                Eroi.roi(1350,1460.82,1550)]
fondo_regions=[Eroi.roi(1611,1764.49,1900),
                Eroi.roi(2480,2614.51,2735),
                Eroi.roi(1350,1460.82,1550)]
...
K_CsI2x2.append([dGuayanaPK_c,ddGuayanaPK_c,ActividadMK,dActividadMK])
Th_CsI2x2.append([dGuayanaTh_c,ddGuayanaTh_c,ActividadMTh,dActividadMTh])
U_CsI2x2.append([dGuayanaU_c,ddGuayanaU_c,ActividadMU,dActividadMU])
